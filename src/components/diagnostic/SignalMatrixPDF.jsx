...
const SIGNALS = [
  ...
  { id: 'startup_stage',        label: 'Startup Stage',         category: 'context',    fired: ({ i }) => i.orgStage === 'STARTUP' },
  ...
  { id: 'duration_long',        label: 'Long Duration',         category: 'duration',   fired: ({ i }) => ['ONE_TO_TWO','TWO_PLUS'].includes(i.frictionDuration) },
  { id: 'duration_mid',         label: 'Mid Duration',          category: 'duration',   fired: ({ i }) => ['SIX_TO_TWELVE','THREE_TO_SIX'].includes(i.frictionDuration) },
  { id: 'downstream_large',     label: 'Wide Downstream',       category: 'downstream', fired: ({ i }) => ['LARGE','FULL_ORG'].includes(i.downstreamPopulation) },
  { id: 'downstream_medium',    label: 'Mid Downstream',        category: 'downstream', fired: ({ i }) => i.downstreamPopulation === 'MEDIUM' },
